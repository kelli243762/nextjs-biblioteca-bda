...
const reportes = [
  ...
  },
  {
    ...
    descripcion: 'Préstamos no devueltos con días de atraso y monto sugerido.',
  ...
  },
  {
    ...
    descripcion: 'Estado del inventario por categoría: disponibles, prestados y perdidos.',
    ...
    <main className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-gray-500 mb-8">
          Sistema de reportes y análisis de préstamos
        </p>
